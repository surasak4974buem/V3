...
function doPost(e) {
  ...
  if (data.action === "sync") {
    ...
    if (data.users && data.users.length > 0) {
      var usersHeaders = [
        "realName", "password", "role", "status", "loginCount"
      ];
